...
func (nle *NetworkLossExecutor) Exec(uid string, ctx context.Context, model *spec.ExpModel) *spec.Response {
	...
	return nle.start(dev, localPort, remotePort, excludePort, destIp, excludeIp, percent,destinationIpPort, ignorePeerPort, force, ctx)
}

func (nle *NetworkLossExecutor) start(netInterface, localPort, remotePort, excludePort, destIp, excludeIp, percent,destinationIpPort string,
